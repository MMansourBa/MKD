          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                @csrf
                <!-- ... (Votre formulaire continue ici) ... -->
                <div class="form-group">
                    <input name="name" type="text" class="form-control form-control-user @error('name')is-invalid @enderror" id="exampleInputName" placeholder="Prenom(s) & Nom">
                    @error('name')
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="{{ route('login_client') }}">Vous avez déjà un compte ? Connectez-vous!</a>
              </div>
            </div>
          </div>
        </div>
