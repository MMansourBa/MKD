...
<head>
    <title>AFROCOUTURE-INSCRIPTION</title>
    <!-- Meta tag Keywords -->
    ...
    <style>
        ...
        .banner-image {
            width: 100%;
            height: 100vh;
            /* 100% de la hauteur de la fenêtre visible */
            object-fit: cover;
            /* Couvrir tout en conservant les proportions de l'image */
            object-position: center top;
            /* Centrer l'image horizontalement et aligner le haut de l'image */
            position: absolute;
            /* Position absolue pour couvrir toute la page */
            top: 0;
            left: 0;
            z-index: -1;
            /* Mettez l'image en arrière-plan (derrière le contenu) */
        }
    ...
    <div class="main-bg">
        ...
        <div class="sub-main-w3">
            <div class="bg-content-w3pvt">
                ...
                <form action="{{ route('visiteurInscription') }}" method="post">
                    @csrf
                    <p class="legend">Inscriver-vous<span class="fa fa-hand-o-down"></span></p>
                    @if (session('status'))
                ...
                <a href="{{ route('visiteurConnexion') }}" class="bottom-text-w3ls">Déjà un Compte? Se connecter.</a>
            </div>
        </div>
        <!-- //content -->
        <!-- copyright -->
